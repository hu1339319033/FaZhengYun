...
import com.example.fazhengyun.databinding.ActivityFindpasswordBinding;
...
public class FindPasswordActivity extends XActivity<ActivityFindpasswordBinding> implements View.OnClickListener {
    ...
    public void initData(Bundle savedInstanceState) {
        getBinding().toolbar.toolbarTitle.setText("找回密码");
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.btn_commit:
                ...
                hashMap.put("newPassword",AppKit.MD5Util.encode(getBinding().etPassword.getText().toString().trim()));
                NetApi.invokeGet(UrlKit.getUrl(ACTION_UpdatePassword), hashMap, new JsonCallback<ResultMsg>() {
                    ...
                    public void onResponse(ResultMsg response, int id) {
                        ...
                        getUiDelegate().toastShort("密码修改成功，请重新登录");
